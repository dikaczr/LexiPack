...
router.post("/generate-column", requireAuth, async (req, res) => {
  try {
    ...
    const fieldHints = {
      ...
      contextSentences: `one additional natural example sentence in ${tName} using the word in a realistic context, distinct from the existing example sentence`,
    };
